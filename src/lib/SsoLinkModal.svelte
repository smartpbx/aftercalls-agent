<!--
  ...
  Mirror-pair component shipped to BOTH portal and agent. The two
  copies must stay byte-identical (`diff portal/src/lib/SsoLinkModal.svelte
  agent/src/lib/SsoLinkModal.svelte` returns nothing) — checked at
  builder verify time, same posture as the existing Avatar.svelte /
  ActionItem.svelte / OfflineBanner.svelte mirror pairs.
