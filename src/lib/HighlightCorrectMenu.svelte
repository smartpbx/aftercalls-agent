<script lang="ts" module>
  ...
  // highlights text inside the summary or transcript region. Mirror
  // pair: portal/src/lib/HighlightCorrectMenu.svelte ≡
  //        agent/src/lib/HighlightCorrectMenu.svelte
