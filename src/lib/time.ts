// Mirror-pair helper — byte-identical between
// portal/src/lib/time.ts and agent/src/lib/time.ts. Reviewer
// enforces with `diff portal/src/lib/time.ts agent/src/lib/time.ts`
// on every touch. Added in v0.4.0 Phase 4 (#105) for the /actions
// row-context line (`{call-title} · {relative-time}`).
//
