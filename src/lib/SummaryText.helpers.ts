...
// a Svelte file.
//
// Mirror-pair file — byte-identical between
//   portal/src/lib/SummaryText.helpers.ts
//   agent/src/lib/SummaryText.helpers.ts
// Reviewer diffs the two on every touch, same discipline as the
// SummaryText.svelte pair this file orbits.
//
// `SummaryText.svelte` re-exports the three symbols below from its
// module-script so existing imports (`$lib/SummaryText.svelte`) keep
// working with no call-site churn — only the underlying definition
// moved.
