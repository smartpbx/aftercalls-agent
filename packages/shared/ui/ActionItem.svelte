...
<script lang="ts">
  // Shared package component used by both portal and agent. Keep
  // surface-specific transport in the parent pages; this file stays
  // presentational so it can ship through the public agent mirror.
  //
