<script lang="ts">
  ...
  // Styles are component-scoped — none of these classes live in
  // app.css, so the `diff portal/src/app.css agent/src/app.css`
...
<style>
  /* Component-scoped styles. None of these classes leak into app.css;
     the `diff portal/src/app.css agent/src/app.css` invariant is
